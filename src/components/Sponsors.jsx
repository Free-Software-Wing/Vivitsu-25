...
export default function SponsorsPage() {
  ...
  return (
    <div className="h-200 bg-gray-900 text-white flex flex-col items-center justify-center p-10 sponsers"
    >
      <motion.h1
      ...
      >
        <div className="sponer-name">🌟 Our Sponsors 🌟</div>
        <br /><br /><br />
      </motion.h1>
      ...
      >
        {sponsors.map((sponsor, index) => (
          ...
          >
            ...
            />
            <p className="mt-2 text-lg font-semibold p-4">{sponsor.name}</p>
          </motion.a>
        ))}
      </motion.div>
    </div>
